...
timezsh() {
  shell=${1-$SHELL}
  for i in $(seq 1 10); do /usr/bin/time -i -c exit; done
}

# If you come from bash you might have to change your $PATH.
# export PATH=$HOME/bin:/usr/local/bin:$PATH
#
# Created by `pipx` on 2024-05-03 00:50:53
export PATH="$PATH:/home/mrchoc/.local/bin"
...
plugins=(zsh-nvm git command-not-found)
